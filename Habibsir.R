...
#install.packages("D://R/GEOquery_2.50.5.tar.gz", repos = NULL, type = "source")

# http://bioconductor.riken.jp/packages/3.8/bioc/src/contrib/GEOquery_2.50.5.tar.gz
...
#gse <- getGEO(filename = "D://R/GSE29231_series_matrix.txt.gz")
