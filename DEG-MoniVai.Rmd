# https://github.com/shafiq-islam-cse/COVID-19--Moni-Vai-resources/blob/main/COVID-19-master/COVID-19-master/DESeq_Count_to_DEG.R
...
data<-read.delim("D://R/GSE107489_gene_counts.txt", header =TRUE, row.names=1)
head(data)
